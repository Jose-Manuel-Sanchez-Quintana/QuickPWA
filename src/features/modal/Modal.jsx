    ...
    <>
      {isopen && (
        <div className="fixed w-screen h-screen p-5 md:p-0 z-50 inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center ">
          <div className="bg-white dark:text-white dark:bg-quick4 p-4 rounded-md max-w-2xl">
            ...
            <div className="flex gap-x-1">
              <button
                ...
                className="border border-light-grey-border dark:border-light-gray-4 rounded-sm p-1 min-w-16"
              >
                Yes
              </button>
              <button

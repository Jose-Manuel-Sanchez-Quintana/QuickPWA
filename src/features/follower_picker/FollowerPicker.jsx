          ...
          <div class="relative h-screen md:h-auto bg-white shadow dark:bg-gray-700">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
              ...
              <button
                type="button"
                onClick={handleClose}
                class="text-gray-400 bg-transparent hover:bg-light-gray-2 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
            ...
            <div className="w-100">
              <input
                type="text"
                className="text-white w-auto bg-transparent border-transparent ring-offset-0 focus:border-transparent focus:ring-0 p-2 font-lg"
              ...
              {participan_list !== null &&
                participan_list.map((participant) => (
                  <Chip
                    ...
                    className="rounded-full hover:bg-red-700 hover:bg-opacity-30 cursor-pointer"
                    onClick={() => {
            ...
            <div class="flex items-center p-4 md:p-5 border-t border-light-gray-2 rounded-b dark:border-gray-600">
              <button
                ...
                type="button"
                class="text-white dark:disabled:bg-slate-600 bg-green-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-700"
              >
                Add
              </button>
            </div>

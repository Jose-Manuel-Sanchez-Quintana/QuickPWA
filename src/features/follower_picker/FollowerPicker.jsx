          ...
          <div className="flex dark:text-white p-4 font-semibold text-xl shrink-0 justify-between items-center border-b border-light-grey-border dark:border-light-gray-8">
            <span className="flex items-center gap-5">
              ...
              <button
                type="button"
                onClick={handleClose}
                class="hidden md:block text-light-gray-8 bg-transparent text-sm ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
            ...
            <button
              ...
              class="block md:hidden text-white disabled:bg-light-gray-8 h-full px-3 bg-quick-green-5 font-medium rounded-lg text-sm text-center"
              onClick={() => {
                handleAddParticipants(
                  current_chatroom.id,

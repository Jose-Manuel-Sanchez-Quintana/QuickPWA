          ...
          <div className="sm:mt-0 sm:text-left break-all w-full">
            ...
            <div className="hover:rounded p-3">
              <span className="flex justify-between">
                <p
                  className="text-xl font-sembold text-slate-400 ml-2 mb-5 hover:underline cursor-pointer"
                  onClick={() => {
                ...
                {is_flagged !== null &&
                  user.role.indexOf("administrator") !== -1 && (
                    <button
                      className={is_flagged ? "text-light-gray-2" : "blue"}
                      onClick={() => {
                        setFlagged(true);
                      }}
                    >
                ...
                <div className="flex items-center space-x-4">
                  ...
                  >
                    {updating_likes ? (
                      ...
                      post.original_post.active === true && (
                        <svg
                          class="cursor-pointer h-6 w-6 ml-2 text-red-500 items-center"
                          viewBox="0 0 24 24"
                          fill={post.original_post.liked ? "red" : "none"}
                          stroke="currentColor"
                          stroke-width="2"
                ...
                <div className="flex items-center space-x-4">
                  {
                    ...
                    >
                      {updating_reposts ? (
                        ...
                        post.original_post.active === true && (
                          <svg
                            className={`cursor-pointer h-6 w-6 ml-2 items-center ${
                              post.original_post.reposted
                                ? "fill-green-400"
                                : "dark:fill-white"
                            }`}
